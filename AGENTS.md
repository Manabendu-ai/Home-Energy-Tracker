...
- Post a test event (Kafka traffic; **direct to ingestion**, no JWT):
    - `curl -X POST http://localhost:8083/api/ingestion -H 'Content-Type: application/json' -d '{"deviceId":"dev-1","timestamp":"2026-01-01T12:00:00Z","watts":1200}'`
- Through the **gateway** (requires JWT): `http://localhost:8080/api/ingestion` with `Authorization: Bearer <token>`.
...
- `ingestion-service/src/main/java/riku/spring/ingestion_service/controller/IngestionController.java`
- `ingestion-service/src/main/java/riku/spring/ingestion_service/service/IngestionService.java`
- `usage-service/src/main/java/riku/spring/usage_service/service/UsageService.java`
- `usage-service/src/main/java/riku/spring/usage_service/config/InfluxDBConfig.java`
- `alert-service/src/main/java/riku/spring/alert_service/service/AlertService.java`
- `api-gateway/src/main/java/riku/spring/api_gateway/route/UserServiceRoutes.java` (and sibling route classes)
- `api-gateway/src/main/java/riku/spring/api_gateway/config/SecurityConfig.java`
